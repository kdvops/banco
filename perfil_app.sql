...
(1, 1, 'Banco BHD', 'do-banco-bhd.svg', 1),
(2, 1, 'Banco Ademi', 'do-banco-ademi.svg', 1),
(3, 1, 'Banreservas', 'do-banreservas.svg', 1),
(4, 1, 'Banco Santa Cruz', 'do-banco-santa-cruz.svg', 1),
(5, 1, 'Bancamerica', 'do-bancamerica.svg', 1),
(6, 1, 'Banco Activo Dominicana', 'do-banco-activo.svg', 1),
(7, 1, 'Banco BDI', 'do-banco-bdi.svg', 1),
(8, 1, 'Banco Caribe', 'do-banco-caribe.svg', 1),
(9, 1, 'Banco del Progreso', 'do-banco-del-progreso.svg', 1),
(10, 1, 'Banco Lafise', 'do-banco-lafise.svg', 1),
(11, 1, 'Banco Lopez de Haro', 'do-banco-lopez-de-haro.svg', 1),
(12, 1, 'Banco Popular Dominicano', 'do-banco-popular-dominicano.svg', 1),
(13, 1, 'Banco Promerica', 'do-banco-promerica.svg', 1),
(14, 1, 'Banco Vimenca', 'do-banco-vimenca.svg', 1),
(15, 1, 'Banesco', 'do-banesco.svg', 1),
(16, 1, 'BellBank', 'do-bellbank.svg', 1),
(17, 1, 'Citibank', 'do-citibank.svg', 1),
(18, 1, 'Scotiabank', 'do-scotiabank.svg', 1),
(19, 1, 'Asociacion Bonao de Ahorros y Prestamos', 'do-asociacion-bonao.svg', 1),
(20, 1, 'Asociacion Cibao de Ahorros y Prestamos', 'do-asociacion-cibao.svg', 1),
(21, 1, 'Asociacion Duarte de Ahorros y Prestamos', 'do-asociacion-duarte.svg', 1),
(22, 1, 'Asociacion La Nacional de Ahorros y Prestamos', 'do-asociacion-la-nacional.svg', 1),
(23, 1, 'Asociacion La Vega Real de Ahorros y Prestamos', 'do-asociacion-la-vega-real.svg', 1),
...
(26, 1, 'Asociacion Peravia de Ahorros y Prestamos', 'do-asociacion-peravia.svg', 1),
(27, 1, 'Asociacion Popular de Ahorros y Prestamos', 'do-asociacion-popular.svg', 1),
(28, 1, 'Asociacion Romana de Ahorros y Prestamos', 'do-asociacion-romana.svg', 1),
